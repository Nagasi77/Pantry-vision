export default function LandingPage() {
  return (
    <div className="min-h-screen bg-white relative overflow-hidden flex flex-col items-center justify-center p-8 text-center">
      ...
      {/* Background*/}
      <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] bg-green-100 rounded-full blur-[120px] opacity-50 z-0"></div>
      <div className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-green-50 rounded-full blur-[120px] opacity-50 z-0"></div>
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <p className="text-xl text-gray-500 max-w-xl mb-12 leading-relaxed font-medium">
          Mendeteksi kesegaran buah dengan Computer Vision. Dibangun dengan metodologi <span className="text-gray-900 font-bold underline decoration-green-500">P U L P</span> untuk hasil prediksi yang presisi.
        </p>
